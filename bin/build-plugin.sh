...
# that must never reach a production site: tests, the Next.js consumer, CI
# config, and a vendor/ directory that holds nothing but dev tooling. This
# script produces the artifact that actually ships — everything in .distignore
# removed — and is what Plugin Check should be pointed at.
#
...
#
# Usage:
#   bin/build-plugin.sh          # build dist/hybrid-delivery/
#   bin/build-plugin.sh --zip    # ...and dist/hybrid-delivery.zip
#
set -euo pipefail
